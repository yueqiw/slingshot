...
#' @docType methods
#'   
#' @description Constructs a \code{SlingshotDataSet} object. Additionally, 
#'   simple helper methods for manipulating \code{SlingshotDataSet} objects are
#'   described below.
#'   
...
#' @name clusterLabels
#'   
#' @param x an object that describes a dataset or a model involving cluster labels.
...
#'   
#' @param x an object that describes a dataset or a model involving a connectivity matrix.
